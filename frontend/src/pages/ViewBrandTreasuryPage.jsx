...
const ViewBrandTreasuryPage = () => {
    ...
    const fetchFile = async () => {
        try {
            ...
            const { data } = await axios.get(`http://localhost:3000/api/upload/get-brandtreasury/${fileId}`, { withCredentials: true });
            setDocument(data);
    ...
    const handleApproval = async () => {
        ...
        try {
            const url = `http://localhost:3000/api/upload/${document._id}/approval`;
