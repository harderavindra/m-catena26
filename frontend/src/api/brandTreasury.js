...
const API_baseURL = "http://localhost:3000/api/brand-treasury";
const API_brandURL = "http://localhost:3000/api/upload/";
...
export const updateStar = async (documentId) => {
    try {
        const response = await axios.patch(`${API_brandURL}star/${documentId}`, {}, { withCredentials: true });
